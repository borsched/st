 ...
 */
static char *font = "Hack Nerd Font Mono:style:pixelsize=22:antialias=true:autohint=true";
static char *font2[] = { "Hack Nerd Font Mono:style:pixelsize=22:antialias=true:autohint=true" };
